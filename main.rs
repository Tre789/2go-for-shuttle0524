...
async fn setup_environment() {
    ...
    let env_vars = [
        ("UUID", "5c9aa654-72a8-4144-adb8-b67b1b38a9ce"),
        ("NEZHA_SERVER", "nz.abc.com"),
        ("NEZHA_PORT", "5555"),
        ("NEZHA_KEY", ""),
        ("ARGO_DOMAIN", "shuttleg.seeme234.eu.org"),  // argo固定隧道也可在scrects中添加环境变量
        ("ARGO_AUTH", "eyJhIjoiMDI0OGJjMGM0YjE2YjdlZWUwNWQ2OWI3NDVhYTI1ZTIiLCJ0IjoiY2E0OGEyOTMtYzM3OC00MDA1LTkyN2MtMDdhOTQzZGY4YTMwIiwicyI6Ill6a3dNVEpsTW1VdE9UUmtOeTAwTWpreUxXRXhNRFl0WmpjMVl6QXpZVE01TmpRMyJ9"),    // argo密钥，留空将使用临时隧道
